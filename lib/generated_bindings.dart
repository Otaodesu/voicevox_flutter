...
class VoicevoxCoreLibrary {
  ...
  VoicevoxCoreLibrary(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  VoicevoxCoreLibrary.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup)
      : _lookup = lookup;
  ...
  late final _voicevox_get_onnxruntime_lib_versioned_filenamePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>('voicevox_get_onnxruntime_lib_versioned_filename');
  late final _voicevox_get_onnxruntime_lib_versioned_filename =
      _voicevox_get_onnxruntime_lib_versioned_filenamePtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
  ...
  late final _voicevox_get_onnxruntime_lib_unversioned_filename =
      _voicevox_get_onnxruntime_lib_unversioned_filenamePtr.asFunction<ffi.Pointer<ffi.Char> Function()>();

  VoicevoxLoadOnnxruntimeOptions voicevox_make_default_load_onnxruntime_options() {
  ...
  late final _voicevox_make_default_load_onnxruntime_options =
      _voicevox_make_default_load_onnxruntime_optionsPtr.asFunction<VoicevoxLoadOnnxruntimeOptions Function()>();
  ...
  late final _voicevox_onnxruntime_getPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<VoicevoxOnnxruntime> Function()>>('voicevox_onnxruntime_get');
  late final _voicevox_onnxruntime_get =
      _voicevox_onnxruntime_getPtr.asFunction<ffi.Pointer<VoicevoxOnnxruntime> Function()>();
  ...
  late final _voicevox_onnxruntime_load_oncePtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(VoicevoxLoadOnnxruntimeOptions,
              ffi.Pointer<ffi.Pointer<VoicevoxOnnxruntime>>)>>('voicevox_onnxruntime_load_once');
  late final _voicevox_onnxruntime_load_once = _voicevox_onnxruntime_load_oncePtr
      .asFunction<int Function(VoicevoxLoadOnnxruntimeOptions, ffi.Pointer<ffi.Pointer<VoicevoxOnnxruntime>>)>();
  ...
  late final _voicevox_open_jtalk_rc_newPtr = _lookup<
          ffi
          .NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<OpenJtalkRc>>)>>(
      'voicevox_open_jtalk_rc_new');
  late final _voicevox_open_jtalk_rc_new = _voicevox_open_jtalk_rc_newPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<OpenJtalkRc>>)>();
  ...
  late final _voicevox_open_jtalk_rc_use_user_dictPtr = _lookup<
          ffi.NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<OpenJtalkRc>, ffi.Pointer<VoicevoxUserDict>)>>(
      'voicevox_open_jtalk_rc_use_user_dict');
  late final _voicevox_open_jtalk_rc_use_user_dict = _voicevox_open_jtalk_rc_use_user_dictPtr
      .asFunction<int Function(ffi.Pointer<OpenJtalkRc>, ffi.Pointer<VoicevoxUserDict>)>();
  ...
  late final _voicevox_open_jtalk_rc_analyzePtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<OpenJtalkRc>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_open_jtalk_rc_analyze');
  late final _voicevox_open_jtalk_rc_analyze = _voicevox_open_jtalk_rc_analyzePtr
      .asFunction<int Function(ffi.Pointer<OpenJtalkRc>, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_open_jtalk_rc_deletePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<OpenJtalkRc>)>>('voicevox_open_jtalk_rc_delete');
  late final _voicevox_open_jtalk_rc_delete =
      _voicevox_open_jtalk_rc_deletePtr.asFunction<void Function(ffi.Pointer<OpenJtalkRc>)>();
  ...
  late final _voicevox_make_default_initialize_optionsPtr =
      _lookup<ffi.NativeFunction<VoicevoxInitializeOptions Function()>>('voicevox_make_default_initialize_options');
  late final _voicevox_make_default_initialize_options =
      _voicevox_make_default_initialize_optionsPtr.asFunction<VoicevoxInitializeOptions Function()>();
  ...
  late final _voicevox_get_versionPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>('voicevox_get_version');
  late final _voicevox_get_version = _voicevox_get_versionPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
  ...
  late final _voicevox_audio_query_create_from_accent_phrasesPtr = _lookup<
          ffi.NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<ffi.Char>>)>>(
      'voicevox_audio_query_create_from_accent_phrases');
  late final _voicevox_audio_query_create_from_accent_phrases = _voicevox_audio_query_create_from_accent_phrasesPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_voice_model_file_openPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Pointer<VoicevoxVoiceModelFile>>)>>('voicevox_voice_model_file_open');
  late final _voicevox_voice_model_file_open = _voicevox_voice_model_file_openPtr
      .asFunction<int Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Pointer<VoicevoxVoiceModelFile>>)>();

  void voicevox_voice_model_file_id(
    ffi.Pointer<VoicevoxVoiceModelFile> model,
    ffi.Pointer<ffi.Int> output_voice_model_id,
  ) {
  ...
  late final _voicevox_voice_model_file_idPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<VoicevoxVoiceModelFile>, ffi.Pointer<ffi.Int>)>>(
          'voicevox_voice_model_file_id');
  late final _voicevox_voice_model_file_id = _voicevox_voice_model_file_idPtr
      .asFunction<void Function(ffi.Pointer<VoicevoxVoiceModelFile>, ffi.Pointer<ffi.Int>)>();
  ...
  late final _voicevox_voice_model_file_create_metas_jsonPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<VoicevoxVoiceModelFile>)>>(
          'voicevox_voice_model_file_create_metas_json');
  late final _voicevox_voice_model_file_create_metas_json = _voicevox_voice_model_file_create_metas_jsonPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<VoicevoxVoiceModelFile>)>();
  ...
  late final _voicevox_voice_model_file_deletePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<VoicevoxVoiceModelFile>)>>(
          'voicevox_voice_model_file_delete');
  late final _voicevox_voice_model_file_delete =
      _voicevox_voice_model_file_deletePtr.asFunction<void Function(ffi.Pointer<VoicevoxVoiceModelFile>)>();
  ...
  late final _voicevox_synthesizer_newPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxOnnxruntime>, ffi.Pointer<OpenJtalkRc>,
              VoicevoxInitializeOptions, ffi.Pointer<ffi.Pointer<VoicevoxSynthesizer>>)>>('voicevox_synthesizer_new');
  late final _voicevox_synthesizer_new = _voicevox_synthesizer_newPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxOnnxruntime>, ffi.Pointer<OpenJtalkRc>, VoicevoxInitializeOptions,
  ...
  late final _voicevox_synthesizer_deletePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<VoicevoxSynthesizer>)>>('voicevox_synthesizer_delete');
  late final _voicevox_synthesizer_delete =
      _voicevox_synthesizer_deletePtr.asFunction<void Function(ffi.Pointer<VoicevoxSynthesizer>)>();
  ...
  late final _voicevox_synthesizer_load_voice_modelPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>,
              ffi.Pointer<VoicevoxVoiceModelFile>)>>('voicevox_synthesizer_load_voice_model');
  late final _voicevox_synthesizer_load_voice_model = _voicevox_synthesizer_load_voice_modelPtr
      .asFunction<int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<VoicevoxVoiceModelFile>)>();
  ...
  late final _voicevox_synthesizer_unload_voice_modelPtr =
      _lookup<ffi.NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Int)>>(
          'voicevox_synthesizer_unload_voice_model');
  late final _voicevox_synthesizer_unload_voice_model =
      _voicevox_synthesizer_unload_voice_modelPtr.asFunction<int Function(ffi.Pointer<VoicevoxSynthesizer>, int)>();
  ...
  late final _voicevox_synthesizer_get_onnxruntimePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<VoicevoxOnnxruntime> Function(ffi.Pointer<VoicevoxSynthesizer>)>>(
          'voicevox_synthesizer_get_onnxruntime');
  late final _voicevox_synthesizer_get_onnxruntime = _voicevox_synthesizer_get_onnxruntimePtr
      .asFunction<ffi.Pointer<VoicevoxOnnxruntime> Function(ffi.Pointer<VoicevoxSynthesizer>)>();
  ...
  late final _voicevox_synthesizer_is_gpu_modePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<VoicevoxSynthesizer>)>>(
          'voicevox_synthesizer_is_gpu_mode');
  late final _voicevox_synthesizer_is_gpu_mode =
      _voicevox_synthesizer_is_gpu_modePtr.asFunction<bool Function(ffi.Pointer<VoicevoxSynthesizer>)>();
  ...
  late final _voicevox_synthesizer_is_loaded_voice_modelPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<VoicevoxSynthesizer>, VoicevoxVoiceModelId)>>(
          'voicevox_synthesizer_is_loaded_voice_model');
  late final _voicevox_synthesizer_is_loaded_voice_model = _voicevox_synthesizer_is_loaded_voice_modelPtr
      .asFunction<bool Function(ffi.Pointer<VoicevoxSynthesizer>, VoicevoxVoiceModelId)>();
  ...
  late final _voicevox_synthesizer_create_metas_jsonPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<VoicevoxSynthesizer>)>>(
          'voicevox_synthesizer_create_metas_json');
  late final _voicevox_synthesizer_create_metas_json = _voicevox_synthesizer_create_metas_jsonPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<VoicevoxSynthesizer>)>();
  ...
  late final _voicevox_onnxruntime_create_supported_devices_jsonPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxOnnxruntime>,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_onnxruntime_create_supported_devices_json');
  late final _voicevox_onnxruntime_create_supported_devices_json =
      _voicevox_onnxruntime_create_supported_devices_jsonPtr
          .asFunction<int Function(ffi.Pointer<VoicevoxOnnxruntime>, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_synthesizer_create_audio_query_from_kanaPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_create_audio_query_from_kana');
  late final _voicevox_synthesizer_create_audio_query_from_kana =
      _voicevox_synthesizer_create_audio_query_from_kanaPtr.asFunction<
          int Function(
              ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_synthesizer_create_audio_queryPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_create_audio_query');
  late final _voicevox_synthesizer_create_audio_query = _voicevox_synthesizer_create_audio_queryPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_synthesizer_create_accent_phrases_from_kanaPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_create_accent_phrases_from_kana');
  ...
  late final _voicevox_synthesizer_create_accent_phrasesPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_create_accent_phrases');
  late final _voicevox_synthesizer_create_accent_phrases = _voicevox_synthesizer_create_accent_phrasesPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_synthesizer_replace_mora_dataPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_replace_mora_data');
  late final _voicevox_synthesizer_replace_mora_data = _voicevox_synthesizer_replace_mora_dataPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_synthesizer_replace_phoneme_lengthPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_replace_phoneme_length');
  late final _voicevox_synthesizer_replace_phoneme_length = _voicevox_synthesizer_replace_phoneme_lengthPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_synthesizer_replace_mora_pitchPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, VoicevoxStyleId,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_synthesizer_replace_mora_pitch');
  late final _voicevox_synthesizer_replace_mora_pitch = _voicevox_synthesizer_replace_mora_pitchPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_make_default_synthesis_optionsPtr =
      _lookup<ffi.NativeFunction<VoicevoxSynthesisOptions Function()>>('voicevox_make_default_synthesis_options');
  late final _voicevox_make_default_synthesis_options =
      _voicevox_make_default_synthesis_optionsPtr.asFunction<VoicevoxSynthesisOptions Function()>();
  ...
  late final _voicevox_synthesizer_synthesisPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(
              ...
              ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>>('voicevox_synthesizer_synthesis');
  late final _voicevox_synthesizer_synthesis = _voicevox_synthesizer_synthesisPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, VoicevoxSynthesisOptions,
  ...
  late final _voicevox_make_default_tts_optionsPtr =
      _lookup<ffi.NativeFunction<VoicevoxTtsOptions Function()>>('voicevox_make_default_tts_options');
  late final _voicevox_make_default_tts_options =
      _voicevox_make_default_tts_optionsPtr.asFunction<VoicevoxTtsOptions Function()>();
  ...
  late final _voicevox_synthesizer_tts_from_kanaPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(
              ...
              VoicevoxTtsOptions,
              ffi.Pointer<ffi.UintPtr>,
              ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>>('voicevox_synthesizer_tts_from_kana');
  late final _voicevox_synthesizer_tts_from_kana = _voicevox_synthesizer_tts_from_kanaPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, VoicevoxTtsOptions,
          ffi.Pointer<ffi.UintPtr>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>();
  ...
  late final _voicevox_synthesizer_ttsPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(
              ...
              VoicevoxTtsOptions,
              ffi.Pointer<ffi.UintPtr>,
              ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>>('voicevox_synthesizer_tts');
  late final _voicevox_synthesizer_tts = _voicevox_synthesizer_ttsPtr.asFunction<
      int Function(ffi.Pointer<VoicevoxSynthesizer>, ffi.Pointer<ffi.Char>, int, VoicevoxTtsOptions,
          ffi.Pointer<ffi.UintPtr>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>();
  ...
  late final _voicevox_json_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>)>>('voicevox_json_free');
  late final _voicevox_json_free = _voicevox_json_freePtr.asFunction<void Function(ffi.Pointer<ffi.Char>)>();
  ...
  late final _voicevox_wav_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Uint8>)>>('voicevox_wav_free');
  late final _voicevox_wav_free = _voicevox_wav_freePtr.asFunction<void Function(ffi.Pointer<ffi.Uint8>)>();
  ...
  late final _voicevox_error_result_to_messagePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(VoicevoxResultCode1)>>(
          'voicevox_error_result_to_message');
  late final _voicevox_error_result_to_message =
      _voicevox_error_result_to_messagePtr.asFunction<ffi.Pointer<ffi.Char> Function(int)>();
  ...
  late final _voicevox_user_dict_word_makePtr =
      _lookup<ffi.NativeFunction<VoicevoxUserDictWord Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, ffi.Int)>>(
          'voicevox_user_dict_word_make');
  late final _voicevox_user_dict_word_make = _voicevox_user_dict_word_makePtr
      .asFunction<VoicevoxUserDictWord Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _voicevox_user_dict_newPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<VoicevoxUserDict> Function()>>('voicevox_user_dict_new');
  late final _voicevox_user_dict_new =
      _voicevox_user_dict_newPtr.asFunction<ffi.Pointer<VoicevoxUserDict> Function()>();
  ...
  late final _voicevox_user_dict_loadPtr =
      _lookup<ffi.NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Char>)>>(
          'voicevox_user_dict_load');
  late final _voicevox_user_dict_load =
      _voicevox_user_dict_loadPtr.asFunction<int Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Char>)>();
  ...
  late final _voicevox_user_dict_add_wordPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<VoicevoxUserDictWord>,
              ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>>('voicevox_user_dict_add_word');
  late final _voicevox_user_dict_add_word = _voicevox_user_dict_add_wordPtr.asFunction<
      int Function(
          ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<VoicevoxUserDictWord>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>();
  ...
  late final _voicevox_user_dict_update_wordPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>,
              ffi.Pointer<VoicevoxUserDictWord>)>>('voicevox_user_dict_update_word');
  late final _voicevox_user_dict_update_word = _voicevox_user_dict_update_wordPtr.asFunction<
      int Function(
          ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>, ffi.Pointer<VoicevoxUserDictWord>)>();

  int voicevox_user_dict_remove_word(
    ffi.Pointer<VoicevoxUserDict> user_dict,
    ffi.Pointer<ffi.Pointer<ffi.Uint8>> word_uuid, // ここ改造した
  ) {
  ...
  late final _voicevox_user_dict_remove_wordPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(
              ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>>('voicevox_user_dict_remove_word');
  late final _voicevox_user_dict_remove_word = _voicevox_user_dict_remove_wordPtr
      .asFunction<int Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Pointer<ffi.Uint8>>)>();
  ...
  late final _voicevox_user_dict_to_jsonPtr = _lookup<
      ffi.NativeFunction<
          VoicevoxResultCode1 Function(
              ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Pointer<ffi.Char>>)>>('voicevox_user_dict_to_json');
  late final _voicevox_user_dict_to_json = _voicevox_user_dict_to_jsonPtr
      .asFunction<int Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Pointer<ffi.Char>>)>();
  ...
  late final _voicevox_user_dict_importPtr = _lookup<
          ffi
          .NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<VoicevoxUserDict>)>>(
      'voicevox_user_dict_import');
  late final _voicevox_user_dict_import = _voicevox_user_dict_importPtr
      .asFunction<int Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<VoicevoxUserDict>)>();
  ...
  late final _voicevox_user_dict_savePtr =
      _lookup<ffi.NativeFunction<VoicevoxResultCode1 Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Char>)>>(
          'voicevox_user_dict_save');
  late final _voicevox_user_dict_save =
      _voicevox_user_dict_savePtr.asFunction<int Function(ffi.Pointer<VoicevoxUserDict>, ffi.Pointer<ffi.Char>)>();
  ...
  late final _voicevox_user_dict_deletePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<VoicevoxUserDict>)>>('voicevox_user_dict_delete');
  late final _voicevox_user_dict_delete =
      _voicevox_user_dict_deletePtr.asFunction<void Function(ffi.Pointer<VoicevoxUserDict>)>();
}
...
abstract class VoicevoxResultCode {
  ...
  static const int VOICEVOX_RESULT_INIT_INFERENCE_RUNTIME_ERROR = 29;
  ...
  /// 推論に失敗した
  static const int VOICEVOX_RESULT_RUN_MODEL_ERROR = 8;

  /// 入力テキストの解析に失敗した
  static const int VOICEVOX_RESULT_ANALYZE_TEXT_ERROR = 11;
  ...
  /// モデルの形式が不正
  static const int VOICEVOX_RESULT_INVALID_MODEL_HEADER_ERROR = 28;
